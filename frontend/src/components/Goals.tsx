...
const Goals = () => {
  ...
  const handleRefreshGoals = () => {
    // The modal already creates the goal on the backend.
    // This function can be connected to GET /goals
    // when your backend provides the endpoint.
  ...
  const handleDeleteGoal = async (id: number) => {
    try {
      ...
      // If your backend supports DELETE /goals/:id,
      // use this request:
      //
      ...
      <div className="mx-auto w-full max-w-2xl">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-text-muted">
              Add and manage your financial goals
            </p>
          </div>
          ...
          <button
            ...
            className="flex cursor-pointer items-center gap-2 rounded-lg bg-blue-700 px-4 py-2.5 font-medium text-white hover:bg-blue-800"
          >
        ...
        {goals.length === 0 && (
          <div className="mt-6 rounded-xl border border-dashed border-border p-8 text-center">
            ...
            <button
              onClick={() => setOpenModal(true)}
              className="mt-3 cursor-pointer text-sm font-semibold text-blue-700 hover:text-blue-800"
            >
              Add your first goal
            </button>
          </div>
